...
export default function Home() {
  return (
    <div className="bg-[#F0F8FF] min-h-screen w-full flex flex-col items-center">
      ...
      {/* Hero Section */}
      <header className="w-full flex flex-col md:flex-row items-center justify-center text-center md:text-left py-12 bg-gray-100 px-6">
        ...
        <div className="md:w-1/2 mt-6 md:mt-0 flex justify-center">
          <video className="w-full max-w-md rounded-lg shadow-lg" autoPlay loop muted>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            <div className="p-6 bg-green-100 rounded-lg shadow">
              ...
              <p className="text-gray-600 mt-2">Edit and manage your restaurant’s menu with a few clicks.</p>
            </div>
            <div className="p-6 bg-blue-100 rounded-lg shadow">
              <h3 className="text-xl font-medium text-gray-700">Theme Personalization</h3>
              <p className="text-gray-600 mt-2">Customize your website theme to match your brand.</p>
            </div>
